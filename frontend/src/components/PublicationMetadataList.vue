        ...
        <v-card-text style="margin-top:-10px;">
            <v-row no-gutters style="margin: 15px 0px -10px -15px;">
                <v-col style="max-width:140px;">
                    <Number class="attributes-list" label="ContentId" v-model="value.parameters.contentId" :editMode="editMode"/>
                </v-col>
                <v-col style="max-width:140px;">
                    <String class="attributes-list" label="Category" v-model="value.parameters.category" :editMode="editMode"/>
                </v-col>
                <v-col style="max-width:140px;">
                    <Number class="attributes-list" label="SubscriptionPrice" v-model="value.parameters.subscriptionPrice" :editMode="editMode"/>
                </v-col>
                <v-col style="max-width:140px;">
...
<script>
    export default {
        ...
        data: () => ({
            editMode: true,
            value: {
                apiPath: 'publicationMetadata/search/publicationMetadataList',
                parameters: {}
            },
        }),
        created() {
